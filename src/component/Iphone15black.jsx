...
function Iphone15black(props) {
  const { nodes, materials } = useGLTF("IphoneThreejs/models/iphone15-black.glb");
  const meshRef = React.useRef();
  useFrame(() => {
    // You can add any animation logic here if needed
    // For example, rotating the model slowly
    if (meshRef.current) {
...
useGLTF.preload("IphoneThreejs/models/iphone15-black.glb");
